-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('CUSTOMER', 'KITCHEN_OWNER', 'ADMIN');

-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PLACED', 'STARTED_PREPARING', 'PREPARED', 'OUT_FOR_DELIVERY', 'DELIVERED', 'CANCELLED');
